...
impl SWModelParameters for Parameters {
    ...
    const COEFF_A: Fq = field_new!(
        Fq,
        "47839347661400380586665476674807327593337090507328638946783828059622120488379"
    );

    /// COEFF_B = 49566111614541698579471125344141012253139318909481858539071063888878560944092
    const COEFF_B: Fq = field_new!(
        Fq,
        "49566111614541698579471125344141012253139318909481858539071063888878560944092"
    );

use crate::curve::secq256k1::{Fq, Fr};
use ark_ec::{
...
/// G1_GENERATOR_X = 53718550993811904772965658690407829053653678808745171666022356150019200052646
pub const G1_GENERATOR_X: Fq = field_new!(
    Fq,
    "53718550993811904772965658690407829053653678808745171666022356150019200052646"
);

/// G1_GENERATOR_Y = 28941648020349172432234515805717979317553499307621291159490218670604692907903
...
#[cfg(test)]
mod test {
    use crate::curve::secq256k1::g1::{G1Affine, G1Projective, Parameters};
